...
[DisplayName("Initial Balance MOD")]
...
public class InitialBalance : Indicator
{
	...
	// NUEVO: bar fin del OR para fijar el centrado tras cierre
	private int _orEndBar = -1;
	...
	[Display(Name = "Show Open Range", GroupName = "Open Range", Order = 10)]
	...
	[Display(Name = "Border Width", GroupName = "Open Range", Order = 20)]
	[Range(1, 100)]
	...
	[Display(Name = "Border Color", GroupName = "Open Range", Order = 30)]
	...
	[Display(Name = "Fill Color", GroupName = "Open Range", Order = 40)]
	...
	// Rótulo del Open Range (centrado)
	[Display(Name = "Show OR Label", GroupName = "Open Range Label", Order = 100)]
	public bool ShowOpenRangeLabel { get; set; } = true;

	[Display(Name = "Label Text", GroupName = "Open Range Label", Order = 110)]
	public string OpenRangeLabelText { get; set; } = "OPEN RANGE";

	[Display(Name = "Label Font Size", GroupName = "Open Range Label", Order = 120)]
	[Range(6, 96)]
	public float OpenRangeLabelFontSize { get; set; } = 14f;

	[Display(Name = "Label Color", GroupName = "Open Range Label", Order = 130)]
	public CrossColor OpenRangeLabelColor { get; set; } = CrossColor.FromArgb(255, 255, 255, 255);
	...
	protected override void OnCalculate(int bar, decimal value)
	{
		...
		// SIEMPRE: actualizar el rótulo del OR (en formación o cerrado)
		if (ShowOpenRangeLabel && _lastStartBar >= 0 && _highLowIsSet)
		{
			var endBarForLabel = _orEndBar >= 0 ? _orEndBar : bar;
			var centerBar = _lastStartBar + (endBarForLabel - _lastStartBar) / 2;
			var centerPrice = (_ibMax + _ibMin) / 2m;

			UpdateOpenRangeLabel(centerBar, centerPrice);
		}
	}
	...
	// Helper: escribe/actualiza el rótulo del Open Range en el centro
	private void UpdateOpenRangeLabel(int centerBar, decimal centerPrice)
	{
		AddText(
			_lastStartBar + "OR_LABEL",
			OpenRangeLabelText,
			true,
			centerBar,
			centerPrice,
			0,
			0,
			ConvertColor(OpenRangeLabelColor),
			System.Drawing.Color.Transparent,
			System.Drawing.Color.Transparent,
			OpenRangeLabelFontSize,
